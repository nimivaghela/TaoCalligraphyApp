...
class AudioDataAdapter(
    private val mListener: OnAudioItemClickListener,
    ...
    fun setAudioData(dataList: ArrayList<ContentData?>) {
        list = dataList
            ...
            holder.binding.apply {
                ...
                ffFavourite.setOnClickListener {
                    if (list[holder.bindingAdapterPosition]?.isFavorite == true) {
                        ...
                        mListener.onAudioAdapterFavoriteClick(
...
//                    can access
    ...
    interface OnAudioItemClickListener {
        fun onAudioAdapterClick(data: ContentData?)
        fun onAudioAdapterFavoriteClick(id: String, adapterPosition: Int)
    }
}