...
class MusicDataAdapter(
    private val mListener: OnMusicItemClickListener,
    ...
    fun setMusicData(dataList: ArrayList<ContentData?>) {
        list = dataList
            ...
            holder.binding.apply {
                ...
                ffFavourite.setOnClickListener {
                    if (list[holder.bindingAdapterPosition]?.isFavorite == true) {
                        ...
                        mListener.onMusicAdapterFavoriteClick(
...
//                    can access
    ...
    interface OnMusicItemClickListener {
        fun onMusicAdapterClick(data: ContentData?)
        fun onMusicAdapterFavoriteClick(id: String, adapterPosition: Int)
    }
}