...
@AndroidEntryPoint
class BeginExperienceTabletActivity : BaseActivity<ActivityBeginExperienceBinding>() {
    ...
    companion object {
        fun startActivity(activity: AppCompatActivity, userExperience: MeditationContentResponse) {
            val intent = Intent(activity, BeginExperienceTabletActivity::class.java)
    ...
    override fun handleListener() {
        ...
        mBinding.btnExperienceMoreBeginExperience.clickWithDebounce {
            ...
            LocalBroadcastManager.getInstance(this).unregisterReceiver(playerNotificationReceiver)
            viewModel.isFromConfigChanges = false
            ...
            ExperienceMoreTabletActivity.startActivity(this)
            isPause = false
            isMoveToMore = true
        }
