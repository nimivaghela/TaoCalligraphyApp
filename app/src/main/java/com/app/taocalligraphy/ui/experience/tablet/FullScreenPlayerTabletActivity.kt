...
class FullScreenPlayerTabletActivity : BaseActivity<ActivityFullScreenVideoPlayerBinding>() {
    ...
    companion object {
        ...
        var instance: FullScreenPlayerTabletActivity? = null
        ...
        fun startActivity(
            ...
            val intent = Intent(activity, FullScreenPlayerTabletActivity::class.java)
...
//        )
    ...
    override fun onPause() {
        TaoCalligraphy.instance.simpleExoPlayer?.run {
            ...
            if (!isBackPressed) {
//                playWhenReady = false
                this@FullScreenPlayerTabletActivity.isPlaying = play
            }
