...
class CountrySelectionDialog(
    ...
    val listener: CountrySelectionListener = countrySelectionListener
    ...
    private fun initView() {
        ...
        itemBindingUtil.btnDone.setOnClickListener {
            ...
            listener.onCountrySelect(itemBindingUtil.numberPickerTimer.value)
            dismiss()
        }
    }
    ...
    interface CountrySelectionListener {
        fun onCountrySelect(selectedPos: Int)
    }
}