...
class WellnessUpcomingSessionAdapter(val sessionClickListener: SessionClickListener) :
    RecyclerView.Adapter<WellnessUpcomingSessionAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val itemBindingUtil =
            ItemCalenderEventListBinding.inflate(
