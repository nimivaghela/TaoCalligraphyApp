...
class SegmentedControlGroup @JvmOverloads constructor(
    ...
    init {
        ...
        inset = resources.getDimensionPixelSize(R.dimen._1sdp).toFloat()
        padding = resources.getDimensionPixelSize(R.dimen._1sdp)
        dividerMargin = resources.getDimensionPixelSize(R.dimen._5sdp)

        orientation = HORIZONTAL
        background = ContextCompat.getDrawable(context, R.drawable.background_rounded_empty)
        setPadding(0, padding, 0, padding)

        if(isTablet(TaoCalligraphy.instance.applicationContext)) {
            sliderRadius = resources.getDimensionPixelSize(R.dimen._10dp).toFloat()
        }else{
            sliderRadius = resources.getDimensionPixelSize(R.dimen._6sdp).toFloat()
        }
        sliderPaint.apply {
