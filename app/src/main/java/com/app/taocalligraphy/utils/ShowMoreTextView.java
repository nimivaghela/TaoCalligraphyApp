...
public class ShowMoreTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    private ProgramsDayWiseListAdapter.MoreClickListener mListener;
    ...
    public void addListenerForMore(ProgramsDayWiseListAdapter.MoreClickListener listener, int contentId) {
    ...
    private void setShowMoreColoringAndClickable() {
        ...
        spannableString.setSpan(new ClickableSpan() {
                                    ...
                                    public void onClick(@Nullable View view) {
                                        mListener.onMoreClick(mContentId);
                                    }
                                },
